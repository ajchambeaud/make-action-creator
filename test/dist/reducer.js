...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('the reducer', function () {
	  it('should add a new key in state when START action was dispatched', function () {
	    var prevState = {};
	    var action = {
	  ...
	  it('should update the status value when SUCCESS action was dispatched', function () {
	    var prevState = {
	      MY_ACTION: {
	        status: 'pending',
	        response: null,
	  ...
	  it('should update the response value when SUCCESS action was dispatched', function () {
	    var prevState = {
	      MY_ACTION: {
	        status: 'pending',
	        response: null,
	  ...
	  it('should update the status and error values when FAILURE action was dispatched', function () {
	    var prevState = {
	      MY_ACTION: {
	        status: 'pending',
	        response: null,
	  ...
	  it('should return null error when FAILURE action is dispatched and no payload is present', function () {
	    var prevState = {
	      MY_ACTION: {
	        status: 'pending',
	        response: null,
	  ...
	  it('should do nothing when other actions are dispatched', function () {
	    var prevState = {
	      MY_ACTION: {
	        status: 'failure',
	        response: null,
	    ...
	    (0, _chai.expect)(newState).to.deep.equal(prevState);
	  });
	});
