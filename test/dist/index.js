...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactReduxSpinner = __webpack_require__(42);
	...
	describe('makeActionCreator', function () {
	  it('should return an action creator function', function () {
	    var actionPrefixType = 'my_action';
	    var actionCreator = (0, _index2.default)(actionPrefixType);

	    (0, _chai.expect)(actionCreator).to.be.a('function');
	  });

	  it('should accept options.rrSpiner flag and when is present adds spinner data to actions start, success and failure', function () {
	    var actionPrefixType = 'my_action';
	    var actionCreator = (0, _index2.default)(actionPrefixType, { rrSpinner: true });

	    (0, _chai.expect)(actionCreator.start('foo')).to.deep.equal(_defineProperty({
	      type: 'MY_ACTION_START',
	      payload: 'foo'
	    }, _reactReduxSpinner.pendingTask, _reactReduxSpinner.begin));

	    (0, _chai.expect)(actionCreator.success('foo')).to.deep.equal(_defineProperty({
	      type: 'MY_ACTION_SUCCESS',
	      payload: 'foo'
	    }, _reactReduxSpinner.pendingTask, _reactReduxSpinner.end));

	    (0, _chai.expect)(actionCreator.failure('foo')).to.deep.equal(_defineProperty({
	  ...
	  describe('actionCreator', function () {
	    it('should return an action object wich include the payload and an uppercase type', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator('foo')).to.deep.equal({
	        type: 'MY_ACTION',
	        payload: 'foo'
	      });
	    });

	    it('should have property `type` equal to the uppercase action type', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.type).to.be.equal('MY_ACTION');
	    });

	    it('should have method `start` that returns an action with the _START type sufix', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.start).to.be.a('function');
	      (0, _chai.expect)(actionCreator.start('foo')).to.deep.equal({
	        type: 'MY_ACTION_START',
	        payload: 'foo'
	      });
	    });

	    it('should have property `START` equal to the uppercase action type with the _START sufix', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.START).to.be.equal('MY_ACTION_START');
	    });

	    it('should have method `success` that returns an action with the _SUCCESS type sufix', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.success).to.be.a('function');
	      (0, _chai.expect)(actionCreator.success('foo')).to.deep.equal({
	        type: 'MY_ACTION_SUCCESS',
	        payload: 'foo'
	      });
	    });

	    it('should have property `SUCCESS` equal to the uppercase action type with the _SUCCESS sufix', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.SUCCESS).to.be.equal('MY_ACTION_SUCCESS');
	    });

	    it('should have method `failure` that returns an action with the _FAILURE type sufix', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.failure).to.be.a('function');
	      (0, _chai.expect)(actionCreator.failure('foo')).to.deep.equal({
	        type: 'MY_ACTION_FAILURE',
	        payload: 'foo'
	      });
	    });

	    it('should have property `FAILURE` equal to the uppercase action type with the _FAILURE sufix', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);

	      (0, _chai.expect)(actionCreator.FAILURE).to.be.equal('MY_ACTION_FAILURE');
	    });

	    it('should allow to pass an object with aditional propertys to merge with action object', function () {
	      var actionPrefixType = 'my_action';
	      var actionCreator = (0, _index2.default)(actionPrefixType);
	      ...
	      (0, _chai.expect)(actionCreator('foo', aditionalFields)).to.deep.equal({
	        type: 'MY_ACTION',
	        payload: 'foo',
	        foo: 'bar',
	        another: 10
	      ...
	      (0, _chai.expect)(actionCreator.start('foo', aditionalFields)).to.deep.equal({
	        type: 'MY_ACTION_START',
	        payload: 'foo',
	        foo: 'bar',
	        another: 10
	      ...
	      (0, _chai.expect)(actionCreator.success('foo', aditionalFields)).to.deep.equal({
	        type: 'MY_ACTION_SUCCESS',
	        payload: 'foo',
	        foo: 'bar',
	        another: 10
	      ...
	      (0, _chai.expect)(actionCreator.failure('foo', aditionalFields)).to.deep.equal({
	        type: 'MY_ACTION_FAILURE',
	        payload: 'foo',
	        foo: 'bar',
	        another: 10
	    ...
	    describe('getStatus method', function () {
	      it('should return the status value of the action in state', function () {
	        var actionPrefixType = 'my_action';
	        var actionCreator = (0, _index2.default)(actionPrefixType);
	        var state = {
	          async: _defineProperty({}, actionCreator.type, {
	            status: 'success'
	          })
	        };
	        (0, _chai.expect)(actionCreator.getStatus(state)).to.be.equal('success');
	      });

	      it('should return a default status value if key not present', function () {
	        var actionPrefixType = 'my_action';
	        var actionCreator = (0, _index2.default)(actionPrefixType);
	        var state = {
	          async: {}
	        };
	        (0, _chai.expect)(actionCreator.getStatus(state)).to.be.equal('init');
	      });
	    });

	    describe('getError method', function () {
	      it('should return the error value of the action in state', function () {
	        var actionPrefixType = 'my_action';
	        var actionCreator = (0, _index2.default)(actionPrefixType);
	        var state = {
	          async: _defineProperty({}, actionCreator.type, {
	        ...
	        (0, _chai.expect)(actionCreator.getError(state)).to.be.equal('something failed');
	      });

	      it('should return null if key not present', function () {
	        var actionPrefixType = 'my_action';
	        var actionCreator = (0, _index2.default)(actionPrefixType);
	        var state = {
	          async: {}
	        };
	        (0, _chai.expect)(actionCreator.getError(state)).to.be.equal(null);
	      });
	    });

	    describe('clearStatus property', function () {
	      it('should return an action object', function () {
	        var actionPrefixType = 'my_action';
	        var actionCreator = (0, _index2.default)(actionPrefixType);
	        (0, _chai.expect)(actionCreator.clearStatus).to.deep.equal({
	          type: 'CLEAR_STATUS',
...
/***/ function(module, exports) {
	...
	var begin = exports.begin = 'rrs-begin';
	var end = exports.end = 'rrs-end';
	var pendingTask = exports.pendingTask = 'rrs-pendingTask';
